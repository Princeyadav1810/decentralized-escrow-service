...
contract EscrowContract {
    ...
    event EscrowCreated(uint256 indexed escrowId, address indexed buyer, address indexed seller, address arbiter, uint256 amount, string description);
    event FundsReleased(uint256 indexed escrowId, address triggeredBy);
    event FundsRefunded(uint256 indexed escrowId, address triggeredBy);
    event EscrowCancelled(uint256 indexed escrowId, address cancelledBy);
    event ArbiterUpdated(uint256 indexed escrowId, address oldArbiter, address newArbiter);
